...
trait Spinning[T]:
  extension (spinning: T) def spin: Spin
...
trait SpinCoord[C <: Coord](val value: SpinValue)
...
case class XSpin(override val value: SpinValue)
  extends SpinCoord[XCoord](value)
...
case class YSpin(override val value: SpinValue)
  extends SpinCoord[YCoord](value)
...
case class ZSpin(override val value: SpinValue)
  extends SpinCoord[ZCoord](value)
