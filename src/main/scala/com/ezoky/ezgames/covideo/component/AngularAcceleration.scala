...
import com.ezoky.ezgames.covideo.component.Dimension.{AngularAccelerationValue, SpinValue}
...
trait AngularAccelerationCoord[C <: Coord, S <: SpinCoord[C], A <: AngularAccelerationCoord[C, S, A]](val value: AngularAccelerationValue):
...
case class XAngularAcceleration(override val value: AngularAccelerationValue)
  extends AngularAccelerationCoord[XCoord, XSpin, XAngularAcceleration](value) :
...
case class YAngularAcceleration(override val value: AngularAccelerationValue)
  extends AngularAccelerationCoord[YCoord, YSpin, YAngularAcceleration](value) :
...
case class ZAngularAcceleration(override val value: AngularAccelerationValue)
  extends AngularAccelerationCoord[ZCoord, ZSpin, ZAngularAcceleration](value) :
