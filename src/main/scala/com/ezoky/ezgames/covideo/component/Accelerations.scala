...
trait Accelerations[T: Dimension]:
  ...
  trait AccelerationCoord[C <: Coord, S <: SpeedCoord[C], A <: AccelerationCoord[C, S, A]]:
    def value: AccelerationValue
  ...
  case class ZAcceleration(override val value: AccelerationValue)
    extends AccelerationCoord[ZCoord, ZSpeed, ZAcceleration]:
